    ...
    <div className="space-y-6">
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        {summaryCards.map((card) => (
          <div
            key={card.label}
            className="border-hairline bg-surface-card shadow-subtle rounded-xl border p-5"
          >
      ...
      <section className="grid gap-6 xl:grid-cols-[1.4fr_0.8fr]">
        <div className="border-hairline bg-surface-card shadow-subtle rounded-xl border p-5">
        ...
        <div className="border-hairline bg-surface-card shadow-subtle rounded-xl border p-5">
          ...
          <div className="mt-4 space-y-3">
            {crewAssignments.map((crew) => (
              <div
                key={crew.crew}
                className="border-hairline bg-canvas flex items-center justify-between rounded-lg border px-3 py-3"
              >
                <div>
