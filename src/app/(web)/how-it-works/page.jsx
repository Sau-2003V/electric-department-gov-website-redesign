export default function HowItWorksPage() {
  const steps = [
    {
      title: "Sign Up / Login",
      description: "Make your account or log in with your meter number.",
    },
    {
      title: "Dashboard Access",
      description:
        "See your meter details, past bills, and shortcuts all in one place.",
    },
    {
    ...
    },
    {
      title: "Track Status",
      description:
        "Check the progress of your complaint and know when it will be fixed.",
    },
    {
      title: "Make Payment",
