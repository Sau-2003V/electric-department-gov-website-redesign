...
import { Mail, MapPin, UserRound, GitBranch } from "lucide-react";
...
const teamMembers = [
  {
    ...
    description:
      "Works on the portal frontend, backend APIs, database integration and overall application development.",
    email: "shivansh.temp@gmail.com",
    github: "github.com/shivansh-tiwari",
  ...
  },
  {
    ...
    github: "github.com/saurabh-vishwakarma",
    location: "Lucknow, Uttar Pradesh",
  },
];
  ...
  return (
    <main className="min-h-screen bg-[#f5f2ec] text-[#171717]">
      {/* <div className="border-b border-[#dedbd5] bg-[#f8f6f1]">
        <div className="mx-auto max-w-[1315px] px-5 py-[11px] text-[13px] text-[#686868]">
          Signed in as{" "}
...
function TeamCard({ member }) {
  return (
    <div className="flex min-h-[390px] flex-col rounded-[19px] border border-[#ddd9d2] bg-[#fffdfa] p-6 shadow-[0_1px_2px_rgba(0,0,0,0.02)] transition-all duration-200 hover:-translate-y-1 hover:shadow-[0_8px_25px_rgba(0,0,0,0.06)]">
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-3 text-[13px] text-[#5f5f5f]">
          <Mail
            size={17}
            strokeWidth={1.8}
            className="shrink-0 text-[#ef5b28]"
          />
