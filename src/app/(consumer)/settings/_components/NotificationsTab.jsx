  ...
  const handleSave = () => {
    ...
    setTimeout(() => {
      ...
      toast.success("Notification preferences updated", {
        description:
          "Your alert subscriptions and preferred channels are active.",
      });
    }, 600);
  };
      ...
      <div className="border-hairline bg-canvas shadow-subtle space-y-6 rounded-xl border p-5 sm:p-7">
        <div>
          ...
          <p className="text-body-sm text-muted-text mt-0.5">
            Configure how and when the Department notifies you regarding grid
            status, maintenance, and bills.
          </p>
        </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-0.5">
                ...
                <p className="text-body-sm text-muted-text">
                  Get notified 24 to 48 hours prior to scheduled feeder
                  shutdowns, pole maintenance, and transformer overhauls.
                </p>
                <span className="text-muted-soft inline-block font-mono text-[11px]">
          ...
          <div className="flex items-start justify-between gap-4 py-4.5">
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-0.5">
                ...
                <p className="text-body-sm text-muted-text">
                  Instant notice when your monthly bill is calculated, followed
                  by reminders 7 days and 2 days before the due date.
                </p>
                <span className="text-muted-soft inline-block font-mono text-[11px]">
          ...
          <div className="flex items-start justify-between gap-4 py-4.5">
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-0.5">
                ...
                <p className="text-body-sm text-muted-text">
                  Automated smart-meter alert if month-to-date kilowatt-hour
                  consumption exceeds your historical 3-month baseline by 25%.
                </p>
                <span className="text-muted-soft inline-block font-mono text-[11px]">
                  Smart Meter Feature
                </span>
          ...
          <div className="flex items-start justify-between gap-4 py-4.5">
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-0.5">
                ...
                <p className="text-body-sm text-muted-text">
                  Receive verifiable digital receipts with transaction reference
                  numbers immediately upon online or counter settlement.
                </p>
                <span className="text-muted-soft inline-block font-mono text-[11px]">
          ...
          <div className="flex items-start justify-between gap-4 py-4.5">
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-0.5">
                ...
                <p className="text-body-sm text-muted-text">
                  Real-time status updates when substation circuit breakers trip
                  or unexpected weather hazards cause widespread outage.
                </p>
                <span className="text-muted-soft inline-block font-mono text-[11px]">
