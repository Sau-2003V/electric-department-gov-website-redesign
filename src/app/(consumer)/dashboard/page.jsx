...
const complaints = [
  ...
  },
  {
    ...
    title: "Street light",
    description:
      "Street lights on the main road stay off all night.",
    status: "Closed",
    priority: "SLA met",
  },
  {
...
export default function DashboardPage() {
  return (
    <div className="min-h-[calc(100vh-61px)] px-[32px] pb-[40px] pt-[34px]">
      ...
      <section className="mb-[30px] flex items-start justify-between">
        ...
        <div>
          ...
          <h1 className="text-[30px] font-bold leading-[34px] tracking-[-0.8px] text-[#111]">
      ...
      <section className="mb-[32px] grid grid-cols-3 gap-[16px]">
        ...
        <div className="h-[128px] rounded-[20px] border border-[#d9d6d0] bg-white px-[21px] py-[19px]">
          <Ticket
            size={20}
            className="mb-[11px] text-[#ff4308]"
          />

          <p className="text-[31px] font-bold leading-[30px] text-[#111]">
            3
          </p>
      ...
      <section className="mb-[30px] rounded-[19px] border border-[#f4c5b3] bg-[#fff0e9] px-[21px] py-[18px]">
        ...
        <p className="text-[13px] text-[#666]">
          ...
          Planned maintenance of the 33/11 kV feeder.
          (Planned, 23 Aug 2026, 2:02 pm)
        </p>
      ...
      <section className="overflow-hidden rounded-[20px] border border-[#d9d6d0] bg-white">
        ...
        <div className="flex items-center justify-between border-b border-[#ddd9d2] px-[21px] py-[17px]">
          ...
          <button
            type="button"
            className="text-[14px] text-[#f4511e]"
          >
            View all
          </button>
